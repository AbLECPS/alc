"""
This script is called by the plugin-wrapper, LaunchActivity.js, which passes down the
...
plugin = LaunchActivity(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
