...
from LaunchActivity import LaunchActivity
from alc_utils.slurm_executor import WebGMEKeys

# DIRECT CONFIG TO COME FROM 'config.launchactivity.js'
os.environ['NODE_ENV'] = 'launchactivity'
...
kwargs = {WebGMEKeys.webgme_port_key: 8000}
plugin = LaunchActivity(webgme, commit_hash, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE, **kwargs)
