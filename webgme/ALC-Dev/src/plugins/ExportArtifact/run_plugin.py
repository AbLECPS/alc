"""
This script is called by the plugin-wrapper, ExportArtifact.js, which passes down the
...
from ExportArtifact import ExportArtifact
...
plugin = ExportArtifact(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
