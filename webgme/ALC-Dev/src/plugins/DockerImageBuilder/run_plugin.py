"""
This script is called by the plugin-wrapper, DockerImageBuilder.js, which passes down the
...
plugin = DockerImageBuilder(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
