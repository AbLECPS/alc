"""
This script is called by the plugin-wrapper, MetaParser.js, which passes down the
...
plugin = MetaParser(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
