"""
This script is called by the plugin-wrapper, LaunchVerification.js, which passes down the
...
plugin = LaunchVerification(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
