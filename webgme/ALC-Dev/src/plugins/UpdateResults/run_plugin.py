"""
This script is called by the plugin-wrapper, UpdateResults.js, which passes down the
...
plugin = UpdateResults(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
