"""
This script is called by the plugin-wrapper, ActivityInit.js, which passes down the
...
from ActivityInit import ActivityInit
...
plugin = ActivityInit(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
