"""
This script is called by the plugin-wrapper, LaunchExpt.js, which passes down the
...
plugin = LaunchExpt(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
