"""
This script is called by the plugin-wrapper, WorkflowExecutor.js, which passes down the
...
plugin = WorkflowExecutor(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
