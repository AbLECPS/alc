"""
This script is called by the plugin-wrapper, ROSGen.js, which passes down the
...
plugin = ROSGen(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
