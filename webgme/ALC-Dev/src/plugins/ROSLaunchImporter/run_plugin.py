"""
This script is called by the plugin-wrapper, ROSLaunchImporter.js, which passes down the
...
from ROSLaunchImporter import ROSLaunchImporter
...
plugin = ROSLaunchImporter(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
