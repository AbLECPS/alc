"""
This script is called by the plugin-wrapper, SetupActivity.js, which passes down the
...
plugin = SetupActivity(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
