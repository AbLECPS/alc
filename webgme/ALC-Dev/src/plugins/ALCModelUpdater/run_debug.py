...
from ALCModelUpdater import ALCModelUpdater

# DIRECT CONFIG TO COME FROM 'config.alcmodelupdater.js'
os.environ['NODE_ENV'] = 'alcmodelupdater'

logger = logging.getLogger('ALCModelUpdater')

# Modify these or add option or parse from sys.argv (as in done in run_plugin.py)
PORT = '5555'
PROJECT_NAME = 'BlueROV_nf'
BRANCH_NAME = 'master'
ACTIVE_NODE_PATH = '/y'
...
node_process = subprocess.Popen(
    [
        ...
        '-o', 'alc',
        '-u', 'alc:alc',
        '-j', '/home/ninehs/ALC/alc_workspace/jupyter/Workflows/alc_BlueROV_nf/DegradationLEC_AM/1612994009439/' +
              'job_data/iteration-0/DataGeneration/results-execute-dg_test_2-0/input/task.json'
    ],
    stdout=sys.stdout,
    stderr=sys.stderr
)
...
plugin = ALCModelUpdater(webgme, commit_hash, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
