"""
This script is called by the plugin-wrapper, UpdateParamTable.js, which passes down the
...
from UpdateParamTable import UpdateParamTable
...
plugin = UpdateParamTable(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
