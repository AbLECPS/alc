"""
This script is called by the plugin-wrapper, Resonate.js, which passes down the
...
plugin = Resonate(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
