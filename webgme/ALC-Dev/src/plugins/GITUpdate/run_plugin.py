"""
This script is called by the plugin-wrapper, GITUpdate.js, which passes down the
...
logger = logging.getLogger('GITUpdate')
...
plugin = GITUpdate(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
