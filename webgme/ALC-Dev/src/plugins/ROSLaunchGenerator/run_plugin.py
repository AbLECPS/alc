"""
This script is called by the plugin-wrapper, ROSLaunchGenerator.js, which passes down the
...
from ROSLaunchGenerator import ROSLaunchGenerator

logger = logging.getLogger('ROSLaunchGenerator')
...
plugin = ROSLaunchGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
