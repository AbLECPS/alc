"""
This script is called by the plugin-wrapper, ROSDeploy.js, which passes down the
...
from ROSDeploy import ROSDeploy
...
plugin = ROSDeploy(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE,USERID)
