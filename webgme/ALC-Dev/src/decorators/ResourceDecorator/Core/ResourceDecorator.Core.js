...
define([
    ...
    function ResourceDecoratorCore() {

    }

    ResourceDecoratorCore.prototype._updateColors = function (skipBorder) {
    ...
    ResourceDecoratorCore.prototype._getNodeColorsFromRegistry = function () {
