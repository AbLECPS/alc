from ParameterUpdates import ParameterUpdates
...
class ParameterManager:
    ...
    def get_combination(self, workflow_data, parameter_name_list):

        workflow_data_tree = workflow_data.get_workflow_data_tree()
        row = workflow_data.get_row()

        parameter_name_set = set(parameter_name_list)
        ...
        for name, value_list in self.parameter_map.items():
            ...
            if name in parameter_name_set or ParameterManager._all_specifier in parameter_name_set:
