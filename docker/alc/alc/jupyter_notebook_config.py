...
#c.NotebookApp.password = 'type:salt:sha1:00223a9b42fc:4a167c34393624614791ae37b04905578d42c258'
...
## Enable culling of kernels after a set amount of idle time. Otherwise, Jupyter will not release memory.
