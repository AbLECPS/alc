...
class genSysIDData:
    ...
    def __init__(self,path):
        ...
        self.odometry_sub=rospy.Subscriber("uuv0/pose_gt_ned", Odometry,self.odom_callback,queue_size = 20)
        self.hsd =rospy.Subscriber("uuv0/delta_hsd",HSDCommand,self.master_callback,queue_size = 20)
