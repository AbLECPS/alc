...
#include "dynamics_bicycle_model_degraded.h"
#include "util.h"
#include "interval.h"
...
// degraded parameters max sim_time = 0.5
// double params[5] = {0.0481, 14.7404, 0.9663, 0.2285, 0.2285};
double params_d[5] = {0.0445, 14.7404, 0.9544, 0.2285, 0.2285};


// implement the derivative using interval arithmetic
double get_derivative_bounds_bicycle_degraded(HyperRectangle* rect, int faceIndex,REAL heading_input, REAL throttle)
{
    REAL u = throttle;
    REAL delta = heading_input;
    REAL ca = params_d[0];                   
    REAL cm = params_d[1];        
    REAL ch = params_d[2];  // These params come from sysid
    REAL lf = params_d[3];
    REAL lr = params_d[4];
