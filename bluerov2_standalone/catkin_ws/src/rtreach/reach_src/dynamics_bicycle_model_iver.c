...
// double params[3] = {-0.0194, 29.7422,  0.7436};
double params[3] = {-0.0002, 780.0573, 0.7628};
// double params[3] = {-0.0000, 774.1502, 0.8409};
...
double get_derivative_bounds_bicycle(HyperRectangle* rect, int faceIndex,REAL heading_input, REAL throttle)
{
    ...
    REAL ca = params[0];                   
    REAL cm = params[1];        
    REAL ch = params[2];  // These params come from sysid
    REAL lf = 0.495;
    REAL lr = 0.495;
