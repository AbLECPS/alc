...
class WPTrajectoryGenerator(object):
    ...
    def _motion_regression_1d(self, pnts, t):
        ...
        [1] Sittel, Florian, Joerg Mueller, and Wolfram Burgard. Computing
            ...
            three-dimensional space. Technical Report 272, Unuuvsity of
    ...
    def interpolate(self, t, *args):
        #print("Most Recent Waypoint ", self.interpolator.most_recent_waypoint)
        ...
        if self.interpolator.is_finished(t) or not self.interpolator.has_started(t):
            ...
            self.interpolator._cur_s = self._cur_s
    ...
    def get_vehicle_controller(self, t):
        if self._has_started:
            wp = self.interpolator.most_recent_waypoint
            print("Most Recent Waypoint ", self.interpolator.most_recent_waypoint_idx)
            return wp.use_NN
