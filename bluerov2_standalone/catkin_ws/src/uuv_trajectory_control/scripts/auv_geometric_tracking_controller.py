...
class AUVGeometricTrackingController:
    ...
    def odometry_callback(self, msg):
        ...
        #print "Difference in Time and Msg", rospy.Time.now().to_sec() - msg.header.stamp.to_sec()
        ...
        #des, controllerID = self.local_planner.interpolate(t)
        ...
        print("Position Errors: ", e_p[0:2])
        print("Magnitude of error: ", np.linalg.norm(e_p[0:2]))
        print("Magnitude of X and Y: ", np.linalg.norm(e_p[0:1]))
