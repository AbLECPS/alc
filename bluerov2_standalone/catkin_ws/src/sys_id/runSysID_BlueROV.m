function [sys, Fit]= runSysID_BlueROV(states,learnFocus,dispL,varargin)
%SYSID Learns a linear dynamical model with the speficied input parameters
%   Outputs:
%       sys = linear dynamical system learned (x,y,yaw,speed)
...
for i=1:length(varargin)
    ...
    outputs = data(:,[1,2,3]); % x,y,qx,qy,qz,qw
    if j == 1
