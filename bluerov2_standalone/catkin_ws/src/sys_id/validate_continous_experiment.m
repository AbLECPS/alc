function err = validate_continous_experiment(csvfilename)
%VALIDATE_CONTINOUS_EXPERIMENT Summary of this function goes here
...
for i=1:length(x)
    t(i) = (i-1)*timeStep;
    xe{i} = simulate_continuous_model(x(i,:),u(i,:),timeStep);
end
