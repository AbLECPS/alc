function quat_validation(csvfilename)
%QUAT_VALIDATION Summary of this function goes here
...
figname = split(strrep(csvfilename,'Quat_Experiments/',''),".");
savename = strcat("quat_images/",'sim',figname{1},".png");
saveas(fig,savename);
end
