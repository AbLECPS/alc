...
class ToBlackboard(subscribers.ToBlackboard):
    ...
    Blackboard Variables:
        * hsd_to_waypoint_rrt: the raw message from topic /uuv0/hsd_to_waypoint_rrt
    Args:
    ...
    def __init__(self, 
        ...
        super(ToBlackboard, self).__init__(name=name,
                                           ...
                                           blackboard_variables={"hsd_to_waypoint_rrt":None},
                                           clearing_policy=py_trees.common.ClearingPolicy.NEVER
                                           )
        self.blackboard = py_trees.blackboard.Blackboard()
        
        self.blackboard.hsd_to_waypoint_rrt = HSDCommand()
