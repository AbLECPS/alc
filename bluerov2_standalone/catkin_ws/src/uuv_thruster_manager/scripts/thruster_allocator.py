...
class ThrusterAllocatorNode(ThrusterManager):
    ...
    def __init__(self):
        ...
        # To deluuv the wrench input with an option to use another body frame
        ...
        self.set_tam_reallocation_service = rospy.Service(
            'thruster_manager/set_tam', TAM, #Make a new for this!
            self.set_tam_reallocation)
    ...
    def set_tam_reallocation(self, request):
        ThrusterManager.reallocate_tam(self, request.allocation_matrix)
        return True
