...
class ActivityInterpreter(ActivityInterpreterBase):
    ...
    def __init__(self, folder_path):
        ...
        self.am_definition_filename = None
    ...
    def get_am_lec_definition(self):
        ...
        return am_definition, lec_definition
    ...
    def setup(self):
        ...
        self.am_definition, self.lec_definition = self.get_am_lec_definition()
    ...
    def check(self):
        ...
        if not self.am_definition:
            mesgs.append("Missing am definition")
        ...
        if not self.current_choice:
            mesgs.append("Missing current-choice or assurance_monitor_type")
