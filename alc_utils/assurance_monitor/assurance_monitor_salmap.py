...
import numpy as np
from deep_salmap_torch import deepSaliencyMap
from icad_salmap_torch import ICAD
...
ASSURANCE_MONITOR_NAME = "AssuranceMonitorSaliencyMapTorch"


class AssuranceMonitorSaliencyMapTorch(AssuranceMonitor):
    _variant = "vae"

    def __init__(self):
        super(AssuranceMonitorSaliencyMapTorch, self).__init__()
        self.epsilon = 0.75
        self.window_size = 10
        self.rpm = None
        self.pim = None
    ...
    def save(self, save_dir, data_formatter_path=None, lec_storage_metadata=None, make_unique_subdir=False):
        ...
        _save_dir = super(AssuranceMonitorSaliencyMapTorch, self).save(_save_dir,
                                                                       data_formatter_path,
    ...
    def save_extra(self, save_dir):
        #save in svdd_model
        self.salmap_model.save_model(save_dir)
        self.salmap_model = None
        self.rpm = None
        self.pim = None
        self.smm = None
    ...
    def train(self, dataloader_training, dataloader_calibration, model_path, **kwargs):
        ...
        self.salmap_model = deepSaliencyMap(**kwargs)
        self.salmap_model.fit(dataloader_training,
