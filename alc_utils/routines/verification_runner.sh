...
export PYTHONPATH=$PYTHONPATH:$ALC_HOME/webgme/ALC-Dev/src/plugins/LaunchVerification

echo "execute robustness verification"
python3.6 $ALC_HOME/webgme/ALC-Dev/src/plugins/LaunchVerification/LaunchVerification/ComputeRobustness.py  "${INPUT_FILE}"
