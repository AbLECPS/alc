...
UUV_RADIUS = 0.333
OBSTACLE_RADIUS = 0.5
FAR_ENCOUNTER_RANGE_M = 20#15.0
CLOSE_ENCOUNTER_RANGE_M = 4.0#4.0
COLLISION_RANGE_M = 3.0#2.0
...
class EventDataFile(Datafile):
    ...
    def read(self, filepath):
        try:
            ...
            #print ("top_event {0}".format(self.top_event))
            #print ("consequence {0}".format(self.consequence))
            #print ("independent_vars_cont {0}".format(self.independent_vars_cont))
